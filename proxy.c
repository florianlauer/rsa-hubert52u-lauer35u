...
int main(int argc,char* argv[]) {
  pid_t pid;
  struct sockaddr_in addr_in,cli_addr,serv_addr;  // Définition des sockets ?? addr_in ??
  struct hostent* host;
  ...
  listen(sockfd,50);                            // La socket se met en écoute, file d'attente de 50 connexions
